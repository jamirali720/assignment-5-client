...
const Hero_Information = () => {
  ...
  return (
    <div className="mt-5 ">
      <div className="bg-gradient-to-r from-sky-600 to-sky-400 text-white text-center py-16">
        ...
        <div className="w-full mx-auto md:w-2/5">
          <input
            ...
            className="w-full py-2 mb-5 indent-4 rounded-lg focus:outline-none text-gray-950 "
